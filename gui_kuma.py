...
def main():
    ...
    world = pygame.Surface((int(scr_size[0] * width_multiplier), int(scr_size[1])), pygame.SRCALPHA, 32)
    ...
    karaoke = Karaoke()
    karaoke.Add([Item(3)],(0,0))
    karaoke.Add([Item(2)],(0,2))
    karaoke.Add([Item(0)],(0,4))
    karaoke.Add([Item(1)],(0,6))
    karaoke.Add([Item(1)],(49,6))
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if event.button == 3:
                    if note_id < 3:
                        ...
                        note_id = 0
                    selected = [Item(note_id)] #add item
                elif event.button == 1:
